...
aliases:
---
<<< [[CH10. Maitriser l évaluation des performances]] | [[CH13. Travailler en équipe]] >>>
...
$$
Délai\ moyende\ recouvrement = \frac{365}{Ratio\ de\ rotation\ des\ comptes\ clients}
$$

## Ratio d'endettement
Permet de voir si la société dépend essentiellement d'emprunts contractés auprès de créancier exterieurs ou de ses fonds propres. Ratio > 1 est défavorable car il indique que la société risque d'avoir des difficultés à rembourser ses dettes. Un ratio bas indique que la société peut améliorer sa rentabilité en accroissant ses dettes.
$$
Ratio\ d'endettement = \frac{passif}{capitaux\ propres}
$$

## Retour sur investissement
RSI ou Return On Investisment (ROI) indique la capacité de la société à dégager des bénéfices pour ses actionnaires et autres investisseurs.
$$
Retour\ sur\ investissement = \frac{revenu\ net}{capitaux\ propres}
$$
## Besoin en Fonds de Roulement
ou BFR.
Cela représente le décalage qu'il y a entre les comptes clients et les charges. Il est financer par les capitaux propres de la dette à long terme. Plus la croissance augmente plus le BFR va augmenter.
